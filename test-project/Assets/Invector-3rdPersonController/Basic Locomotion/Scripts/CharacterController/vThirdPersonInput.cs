...
namespace Invector.vCharacterController
{
  ...
  public class vThirdPersonInput : vMonoBehaviour, vIAnimatorMoveReceiver
  {
    ...
    public GenericInput horizontalInput = new ("Horizontal", "LeftAnalogHorizontal", "Horizontal");
    public GenericInput verticallInput = new ("Vertical", "LeftAnalogVertical", "Vertical");
    public GenericInput sprintInput = new ("LeftShift", "LeftStickClick", "LeftStickClick");
    public GenericInput crouchInput = new ("C", "Y", "Y");
    public GenericInput strafeInput = new ("Tab", "RightStickClick", "RightStickClick");
    public GenericInput jumpInput = new ("Space", "X", "X");
    public GenericInput rollInput = new ("Q", "B", "B");
    ...
    [vEditorToolbar("Inputs")]
    [Header("Camera Input")]
    public GenericInput rotateCameraXInput = new ("Mouse X", "RightAnalogHorizontal", "Mouse X");
    public GenericInput rotateCameraYInput = new ("Mouse Y", "RightAnalogVertical", "Mouse Y");
    public GenericInput cameraZoomInput = new ("Mouse ScrollWheel", "", "");

    [vEditorToolbar("Events")]
    public UnityEvent OnLockCamera;
    public UnityEvent OnUnlockCamera;
    public UnityEvent onEnableAnimatorMove = new ();
    public UnityEvent onDisableDisableAnimatorMove = new ();
    ...
    {
      if (TryGetComponent<vThirdPersonController>(out cc))
      {
        cc.Init();
      }
  ...
  class vAnimatorMoveSender : MonoBehaviour
  {
    ...
    //  Cursor.visible = false;
    //  Cursor.lockState = CursorLockMode.Locked;
    //  print($"Cursor.visible: {Cursor.visible}");
